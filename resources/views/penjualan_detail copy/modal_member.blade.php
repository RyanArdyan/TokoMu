                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table id="table_member" class="table table-striped table" width="100%">
                                ...
                                <tbody>
                                    {{-- $semua_member didapatkan dari PenjualanDetailController, method index --}}
                                    {{-- lakukan pengulangan terhadap variabel semua_member agar mendapat semua detail_member yang disimpan dalam variabel $member --}}
                                    @foreach ($semua_member as $member)
                                        <tr>
                                            {{-- panggil fungsi helpers angka bentuk --}}
                                            {{-- $loop->iteration() akan membuat pengulanagan nomor --}}
                                            <td width="5%">{{ angka_bentuk($loop->iteration) }}</td>
                                            <td width="10%">
                                                {{-- cetak value detail_member, column kode_member --}}
                                            ...
                                            <td width="5%">
                                                {{-- tombol Pilih ketika di clikc maka panggil fungsi pilih_member milik javascript lalu kirimkan value $detail_member, column member_id dan value column kode_member --}}
