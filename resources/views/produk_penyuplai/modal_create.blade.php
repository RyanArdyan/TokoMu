                ...
                <form id="form_tambah" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {{-- pada saat key keybard di tekan maka panggil fungsi number lalu kirimkan acara nya, fungsi itu akan melarang user memasukkan huruf dan hanya memperbolehkan angka --}}
                                <input id="harga" name="harga" class="harga_input input form-control input_angka" type="text"
                                placeholder="Masukkan Harga" onkeypress="return number(event)" data-inputmask="'alias': 'decimal', 'prefix': 'Rp ', 'groupSeparator':  '.',  'removeMaskOnSubmit': true, 'autoUnMask': true, 'rightAlign': false, 'radixPoint': ','" autocomplete="off">
                                {{-- pesan error --}}
